...
generateImageSet () {
    ...
    WidthXX=$WIDTH*0.67
    WidthX=$WIDTH*0.33
    convert $sourceIconName -resize $WidthX*$WidthX $destination/$iconName.png
    convert $sourceIconName -resize $WidthXX*$WidthXX $destination/$iconName@2x.png
    convert $sourceIconName -resize $WIDTH*$WIDTH $destination/$iconName@3x.png
